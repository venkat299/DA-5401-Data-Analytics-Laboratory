...
# ---------------------
(train, test, evaldt) = selection.split_data_for_interpolation(data, 0.7, 0.15)
...
ax_2.set_title(f'Interpolation of eval data 15 %')
ax_2.legend()
...
ax_3.set_title(f'Interpolation of test data 15 %')
ax_3.legend()
