...
# Test Accuracy score of the model : 0.99
# Train Accuracy score of the model : 0.9899166666666667
# (12000,) (12000,)
...
plt.savefig(os.path.join(_dir,'img/03-01-confusion_log_reg.png'), dpi=300)
plt.show()
...
plt.savefig(os.path.join(_dir,'img/03-01-ROC_log_reg.png'), dpi=300)
plt.show()